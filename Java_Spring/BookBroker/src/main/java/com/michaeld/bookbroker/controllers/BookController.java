package com.michaeld.bookbroker.controllers;
...
import com.michaeld.bookbroker.services.BookService;
import com.michaeld.bookbroker.services.UserService;
...
public class BookController {
	...
	public String index(Model model, HttpSession session) {
		...
		model.addAttribute("userBooks", bookService.getByUserId((Long) session.getAttribute("userId")));
	...
	public String newBook(@PathVariable("bookId") Long id, Model model, HttpSession session) {
		...
		if (!(book.getPostedBy().getId()).equals((Long) session.getAttribute("userId")) || book.getBorrowedBy() != null) {
			return "redirect:/books";
		}
	...
	public String borrowBook(@PathVariable("id") Long id, HttpSession session) {
		...
		Book book = bookService.getById(id);
		book.setBorrowedBy(userService.getById((Long) session.getAttribute("userId")));
		bookService.update(book);
		return "redirect:/books";
	}
